...
A dossier's public working state is a revision carrying the residual — the dissents and risks
still open for deliberation. Both are addressable, provenance-bound, conservatively retained,
and durably persisted, so convergence can be computed mechanically and survives a store
round-trip.
